...
export default function Page(): React.JSX.Element {
  ...
  // Fetch segments
  const { data: segmentsData, isLoading, error } = useQuery({
    queryKey: ['segments'],
    ...
    <Box sx={{ p: 'var(--Content-padding)' }}>
      <Stack spacing={3}>
        ...
        >
          ...
          <Stack direction="row" spacing={2}>
            <Button
              variant="outlined"
              color="primary"
              startDecorator={isSuggestingSegments ? <CircularProgress size="sm" /> : <LightbulbIcon size={16} />}
        ...
        {deleteError && (
          <Alert color="danger">
            <Typography level="body-md">
              Failed to delete segment: {deleteError}
            </Typography>
          </Alert>
        )}
        ...
        {isSuggestingSegments ? (
          <Card variant="outlined" sx={{ p: 4 }}>
            <Stack spacing={2} alignItems="center" textAlign="center">
              ...
              <Typography level="body-md" color="neutral">
                Generating market segment suggestions based on your company&apos;s positioning and target markets. This typically takes 30-60 seconds.
              </Typography>
            </Stack>
          </Card>
        ) : segments.length === 0 ? (
