...
export default function CreateVisualStyleGuidePage(): React.JSX.Element {
  ...
  React.useEffect(() => {
    if (!isLoading && firstStyleGuide) {
      router.replace(
        `/style-guide/pages/visual-style-guide/${firstStyleGuide.visual_style_guide_id}`
      );
    }
      ...
      <Stack spacing={3}>
        ...
        <Stack spacing={1}>
          ...
          <Typography level='body-md' color='neutral'>
            Set up a visual identity for your company that can be applied across social banners and
            templates
          </Typography>
        </Stack>
