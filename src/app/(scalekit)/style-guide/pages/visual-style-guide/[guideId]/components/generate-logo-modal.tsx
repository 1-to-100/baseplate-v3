    ...
    <Modal open={open} onClose={handleClose}>
      ...
      >
        ...
        <Typography level="body-md" color="neutral" sx={{ mt: 1 }}>
          Tell us how you imagine your logo! Describe the style, colors, icons, or vibe you want, and our AI will create it for you.
        </Typography>
                  ...
                  <Grid key={logo.id} xs={4}>
                    <Card
                      ...
                      sx={{
                        ...
                        overflow: "hidden",
                        border: "2px solid",
                        borderColor: selectedLogoId === logo.id ? "primary.500" : "neutral.outlinedBorder",
