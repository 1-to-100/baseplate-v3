...
import { MagicWand as MagicWandIcon, FloppyDisk as SaveIcon } from '@phosphor-icons/react/dist/ssr';
    ...
    <Stack spacing={3} sx={{ mt: 2 }}>
      ...
      >
        <Stack spacing={1}>
          ...
          <Typography level='body-sm' color='neutral'>
            Define imagery tone and example usage to ensure consistent photography and illustration
            across assets
          </Typography>
        </Stack>
        <Stack direction='row' spacing={2}>
          <Button variant='outlined' startDecorator={<MagicWandIcon />} onClick={handleRegenerate}>
            Regenerate with AI
          </Button>
          <Button startDecorator={<SaveIcon />} onClick={handleSave} loading={isSaving}>
            Save
          </Button>
        </Stack>
      </Stack>
      ...
      <Card>
        <Stack spacing={2}>
          ...
          />
          <Typography level='body-sm' color='neutral'>
            Describe the visual style, mood, color palette usage, and types of images that should be
            used in social banners and templates.
          </Typography>
        </Stack>
      </Card>
    </Stack>
