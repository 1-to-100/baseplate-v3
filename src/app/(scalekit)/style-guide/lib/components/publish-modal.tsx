        ...
        <Stack spacing={3} sx={{ mt: 3 }}>
          ...
          <Stack spacing={2}>
            ...
            <Typography level='body-sm' color='neutral'>
              When checked, all social templates will be locked and marked as published. This makes
              the guide immutable for downstream template generation.
            </Typography>
          </Stack>
