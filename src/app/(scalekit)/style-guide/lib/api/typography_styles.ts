...
import {
  ...
  type UpdateTypographyStyle,
} from '../types';
import { getContext } from './context';

export async function listTypographyStyles(
  visualStyleGuideId?: Id,
  params: ListParams = {}
): Promise<ApiResult<TypographyStyle[]>> {
...
export async function createTypographyStyle(
...
export async function updateTypographyStyle(
  id: Id,
