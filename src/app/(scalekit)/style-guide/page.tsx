...
const navigationCards: NavigationCard[] = [
  {
    ...
    description:
      'Create and manage your written style guide with tone, voice, and messaging guidelines',
  ...
  },
  {
    ...
    description:
      'Create and manage visual style guides with colors, typography, logos, and imagery',
