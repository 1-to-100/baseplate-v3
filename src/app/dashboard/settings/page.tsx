  ...
  return (
    <Box sx={{ p: { xs: 2, sm: 3, md: 4 }, overflowX: 'auto' }}>
      <Stack spacing={{ xs: 2, sm: 3 }}>
        <Typography fontSize={{ xs: 'xl2', sm: 'xl3', lg: 'xl4' }} level='h1'>
          Settings
        </Typography>
        <Box
          sx={{
                ...
                <td style={{ textAlign: 'center' }}>
                  ...
                  >
                    <Checkbox
                      ...
                      onChange={() => handleCheckboxChange('documentation', 'email')}
                    />
                  </Box>
                </td>
                <td style={{ textAlign: 'center' }}>
                  ...
                  >
                    <Checkbox
                      ...
                      onChange={() => handleCheckboxChange('documentation', 'inApp')}
                    />
                  </Box>
                </td>
              </tr>
                ...
                <td style={{ textAlign: 'center' }}>
                  ...
                  >
                    <Checkbox
                      ...
                      onChange={() => handleCheckboxChange('importantNotices', 'email')}
                    />
                  </Box>
                </td>
                <td style={{ textAlign: 'center' }}>
                  ...
                  >
                    <Checkbox
                      ...
                      onChange={() => handleCheckboxChange('importantNotices', 'inApp')}
                    />
                  </Box>
                </td>
              </tr>
                ...
                <td style={{ textAlign: 'center' }}>
                  ...
                  >
                    <Checkbox
                      ...
                      onChange={() => handleCheckboxChange('authentication', 'email')}
                    />
                  </Box>
                </td>
                <td style={{ textAlign: 'center' }}>
                  ...
                  >
                    <Checkbox
                      ...
                      onChange={() => handleCheckboxChange('authentication', 'inApp')}
                    />
                  </Box>
                </td>
              </tr>
                ...
                <td style={{ textAlign: 'center' }}>
                  ...
                  >
                    <Checkbox
                      ...
                      onChange={() => handleCheckboxChange('subscription', 'email')}
                    />
                  </Box>
                </td>
                <td style={{ textAlign: 'center' }}>
                  ...
                  >
                    <Checkbox
                      ...
                      onChange={() => handleCheckboxChange('subscription', 'inApp')}
                    />
                  </Box>
                </td>
              </tr>
