      ...
      <Stack spacing={3}>
        ...
        <Stack divider={<Divider />} spacing={5}>
              ...
              <div>
                <div>
                  <Link
                    level='body-sm'
                    startDecorator={
                      <EnvelopeIcon fontSize='var(--joy-fontSize-md)' weight='bold' />
                    }
                  >
          ...
          <Stack spacing={3}>
            ...
            <Typography>
              &quot;Please ensure that the package is securely wrapped to protect fragile items. If
              no one is available to receive the delivery, kindly leave it with a trusted neighbor.
