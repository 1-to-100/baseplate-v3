...
const ImpersonationContext = React.createContext<ImpersonationContextValue | undefined>(undefined);

export interface ImpersonationProviderProps {
  children: React.ReactNode;
}

export function ImpersonationProvider({ children }: ImpersonationProviderProps): React.JSX.Element {
  ...
  const handleSetImpersonatedUserId = React.useCallback(async (userId: string | null) => {
    if (userId) {
      try {
