...
export default function NotificationFilter({
  ...
  return (
    <>
      ...
      >
        {filterCount > 0 ? `${filterCount} filter${filterCount !== 1 ? 's' : ''} apply` : 'Filter'}
      </Button>
                ...
                >
                  <Box
                    sx={{
                      ...
                      borderRadius: '4px',
                      border:
                        activeCategory === 'Type' ? '1px solid var(--joy-palette-divider)' : 'none',
                      cursor: 'pointer',
                    }}
                  ...
                  >
                    <Typography
                      ...
                      sx={{
                        color:
                          activeCategory === 'Type' ? 'var(--joy-palette-text-primary)' : '#32383E',
                  ...
                  <Box
                    sx={{
                      ...
                      borderRadius: '4px',
                      border:
                        activeCategory === 'User' ? '1px solid var(--joy-palette-divider)' : 'none',
                      cursor: 'pointer',
                    }}
                  ...
                  >
                    <Typography
                      ...
                      sx={{
                        color:
                          activeCategory === 'User' ? 'var(--joy-palette-text-primary)' : '#32383E',
                        fontSize: { xs: '14px', sm: '16px' },
                      }}
                    >
                      User
