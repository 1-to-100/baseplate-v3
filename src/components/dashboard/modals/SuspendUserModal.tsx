  ...
  return (
    <Modal open={open} onClose={onClose}>
      ...
      >
        ...
        >
          <span style={{ color: 'var(--joy-palette-text-primary)' }}>{userName}</span> will be
          temporarily suspended and unable to access their account. You can reactivate them later.
        </Typography>
        <Stack spacing={0.5}>
          <Typography
            level='body-sm'
