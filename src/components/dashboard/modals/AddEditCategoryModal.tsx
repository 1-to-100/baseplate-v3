...
export default function AddEditCategory({
  ...
  const handleSubcategoryChange = (e: React.SyntheticEvent | null, newValue: string | null) => {
        ...
        <Stack spacing={2}>
            ...
            >
              ...
              <div onClick={handleAddNewCategoryClick}>
                ...
                >
                  ...
                  <span style={{ color: '#3D37DD', fontSize: '14px' }}>Add new category</span>
                </Stack>
              </div>
              {isAddingSubcategory && (
                <Stack
          ...
          <Stack sx={{ flex: 1 }}>
            ...
            <Select
              ...
              value={formData.icon}
              onChange={(e, newValue) => handleInputChange('icon', newValue as string)}
              renderValue={(option) => {
