...
export default function ResetPasswordUserModal({
  ...
  const [selectedEmail, setSelectedEmail] = useState<string>(emailArray[0] || '');
    ...
    <Modal open={open} onClose={onClose}>
      ...
      >
        ...
        >
          ...
          <span style={{ color: 'var(--joy-palette-text-primary)' }}>{userName}</span> will receive
          an email with instructions to create a new password. Please ensure the email address is
