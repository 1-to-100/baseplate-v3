...
1. **Navigate to the e2e testing directory:**
...
3. **Configure environment variables:**
   ...
   Copy the example environment file and fill in your values (make sure you're in the `testing/e2e` directory):

   ```bash
   cp .env.example .env
   ```

   **Important:** The `.env` file should be created in the root of the `testing/e2e` directory, not in the project root.
