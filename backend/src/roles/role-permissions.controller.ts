...
export class RolePermissionsController {
  ...
  async checkPermission(
    ...
    const hasPermission = await this.rolePermissionsService.hasPermission(roleId, permissionId);
  ...
  async setRolePermissions(
    ...
    return this.rolePermissionsService.setRolePermissions(roleId, setPermissionsDto.permission_ids);
  }
  ...
  async removePermissionFromRole(
    ...
    await this.rolePermissionsService.removePermissionFromRole(roleId, permissionId);
